...
@Composable
fun CurriculumVitaeScreen(navController: NavHostController, userViewModel: UserViewModel) {
    ...
    fun handleSave () {
        coroutineScope.launch {
            curriculumVitaeViewModel.uploadCurriculum(
                uri = selectedFileUri!!,
                onSuccess = {
            ...
            user?.let { userViewModel.updateCurriculumObservation(it.id, "") }
            user?.let { userViewModel.updateCurriculumReviewed(it.id, false) }
        }
    }
    ...
    Surface(
        ...
        Column(
            ...
            Text(
                text = "You need to submit your curriculum. This section can be edited until the end date",
            ...
            if(!user!!.curriculumAccepted) {
                ...
                user!!.curriculumObservation.let {
                    if (it.isNotEmpty()) {
                        Text(
                            text = "Observation: $it",
                            textAlign = TextAlign.Justify,
